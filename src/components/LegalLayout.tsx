    ...
    <main style={{ paddingBottom: '100px', minHeight: '80vh' }}>
      ...
      <section style={{ 
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', position: 'relative', zIndex: 2 }}>
          <h1 style={{ fontSize: 'clamp(2.5rem, 6vw, 4rem)', fontWeight: 800, marginBottom: '20px', color: '#fff' }}>
            {title}
          </h1>
          {subtitle && (
            <p style={{ color: 'rgba(255,255,255,0.9)', fontSize: '1.2rem', maxWidth: '800px', lineHeight: 1.6 }}>
              {subtitle}
            </p>
          )}
        </div>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 5%' }}>
        ...
        <div className="glass-card" style={{ position: 'relative', padding: '60px', lineHeight: 1.8, color: 'var(--text-grey)' }}>
          {children}
        </div>
      </div>
    </main>
